...
{	
	'use strict';
	var allHeights = [];
	$('.dzseth > div, .dzseth .seth').each(function(e){
...
$(document).ready(function() {
	...
	dezText(['One Page Template', 'Design', 'Idea'], "text");
	...
	/* gallery filter activation = $.mixitup.min.js */ 
	...
	/* Timer JS */
	$('.countdown').countdown({date: '30 feb 2018 23:5'}, function() {
...
$(window).load(function () {
	...
	/* TouchSpin box function by  = $.bootstrap-touchspin.js */ 
	$("input[name='demo_vertical2']").TouchSpin({
      verticalbuttons: true,
      verticalupclass: 'glyphicon glyphicon-plus',
      verticaldownclass: 'glyphicon glyphicon-minus'
    });
	/* TouchSpin box function by  = $.bootstrap-touchspin.js end*/
